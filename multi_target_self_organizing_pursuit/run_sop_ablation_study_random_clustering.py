...
from lib.predators.self_organized_predator_ablation_study_random_clustering \
    import SelfOrganizedPredatorRandomClustering as SelfOrganizedPredator
...
def parse_args():
    ...
    data_log_folder = "data/ablation_study/random_clustering"
