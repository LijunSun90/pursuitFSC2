...
from lib.predators.clustering import Clustering
...
class SelfOrganizedPredatorFishSchoolingSearch(MatrixAgent):
    def __init__(self, env, idx_predator, under_debug=False):
        super(SelfOrganizedPredatorFishSchoolingSearch, self).__init__(env,
                                                    idx_predator,
                                                    under_debug)
