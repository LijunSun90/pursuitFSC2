...
def parse_args():
    ...
    data_log_path = 'data/log_mappo/sop_ippo/'
    os.makedirs(data_log_path, exist_ok=True)
    parser.add_argument("--data_log_path", type=str, default=data_log_path)

    parser.add_argument("--save_model_name_actor", type=str, default='sop_ippo_model_actor.pth')
    parser.add_argument("--save_model_name_critic", type=str, default='sop_ippo_model_critic.pth')
    parser.add_argument("--save_model_name_value_normalizer", type=str, default='sop_ippo_model_value_normalizer.pth')

    parser.add_argument("--resume_model", type=bool, default=False)
    parser.add_argument("--resume_model_name_actor", type=str, default='sop_ippo_model_actor.pth')
    parser.add_argument("--resume_model_name_critic", type=str, default='sop_ippo_model_critic.pth')
    parser.add_argument("--resume_model_name_value_normalizer", type=str,
                        default='sop_ippo_model_value_normalizer.pth')
