...
from lib.predators.self_organized_predator_ablation_study_hard_clustering \
    import SelfOrganizedPredatorHardClustering as SelfOrganizedPredator
...
def parse_args():
    ...
    parser.add_argument('--n_pursuers', '-np', type=int, default=4*2)
    parser.add_argument('--n_targets', '-nt', type=int, default=2)
    ...
    data_log_folder = "data/ablation_study/hard_clustering"
