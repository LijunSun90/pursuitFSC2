...
def parse_args():
    ...
    data_log_path = 'data/log_mappo/sop_mappo_global_state/'
...
class RunExperiment:
    ...
    def step_1_create_environment(self):
        ...
        self.dim_centralized_observation = self.env.world_rows * self.env.world_columns * 3 + 2
    ...
    def step_4_0_warm_up(self):
        ...
        if self.args.use_centralized_V:
            share_obs = self.env.perceive_swarm_global_state()
        else:
    ...
    def step_4_1_experiment_of_an_epoch(self):
        ...
        for t in range(self.args.steps_per_epoch):
            ...
            data = next_observations, share_obs, rewards, self.game_done, values, actions, action_log_probs
    ...
    def insert(self, data):
        ...
        obs, share_obs, rewards, game_done, values, actions, action_log_probs = data
