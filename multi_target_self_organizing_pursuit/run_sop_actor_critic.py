...
from lib.predators.self_organized_predator import SelfOrganizedPredator
from lib.predators.rl_pursuer_actor_critic import RLPursuerActorCritic as RLPursuerSwarm
...
def parse_args():
    ...
    parser.add_argument('--n_pursuers', '-np', type=int, default=4*256)
    parser.add_argument('--n_targets', '-nt', type=int, default=256)
    ...
    data_log_folder = "data/log_actor_critic/sop_actor_critic"
...
def run_policy(arg_list):
    ...
    predators = initialize_predator_swarm(env, arg_list.data_log_folder)
    ...
    while i_episode < arg_list.n_episodes:
        ...
        action_predators = predators.get_action()
        ...
        for idx_predator in priorities:
            ...
            #           ep_len, idx_predator, predators.role, predators.swarm_global_positions[idx_predator])
...
def initialize_predator_swarm(env, data_log_folder):

    return RLPursuerSwarm(env, data_log_folder)
