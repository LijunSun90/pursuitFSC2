...
from lib.predators.self_organized_predator_ablation_study_fish_schooling_search \
    import SelfOrganizedPredatorFishSchoolingSearch as SelfOrganizedPredator
...
def parse_args():
    ...
    data_log_folder = "data/ablation_study/fish_schooling_search"
