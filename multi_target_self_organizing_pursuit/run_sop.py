...
def parse_args():
    ...
    parser.add_argument('--n_pursuers', '-np', type=int, default=4*23)
    parser.add_argument('--n_targets', '-nt', type=int, default=23)
