...
data_path = "./results/stp_actor_critic_4p_1t_6x6_reward_10_1e_4/stp_actor_critic_4p_1t_6x6_reward_10_1e_4_s0/"
...
def parse_args():
    ...
    parser.add_argument('--x_size', '-xs', type=int, default=6)
    parser.add_argument('--y_size', '-ys', type=int, default=6)
    parser.add_argument('--n_pursuers', '-np', type=int, default=4)
    parser.add_argument('--n_targets', '-nt', type=int, default=1)
    parser.add_argument('--episode_len', '-l', type=int, default=500)

    parser.add_argument('--render', '-r', default=True)
    parser.add_argument('--save_frames', '-sf', default=True)
